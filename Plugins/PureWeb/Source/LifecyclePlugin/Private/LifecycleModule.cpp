...
{
	UE_LOG(PureWebPlatform, Log, TEXT("PureWeb Platform Plugin Version: 5.0"));
}
...
{
	InputComponent = (UPixelStreamingInput*)NewPlayer->GetComponentByClass(UPixelStreamingInput::StaticClass());
